    ...
    <div class="cookies__alert">
        <div class="cookies__container">
            <div class="cookies__wrapper">
                ...
                <div class="flex flex-col justify-between mt-3 gap-3">
                    @cookieconsentbutton(action: 'accept.essentials', label: __('cookieConsent::cookies.essentials'), attributes: ['class' => ' cookiesBtn--essentials bg-gray-300 text-white px-4 py-2 rounded text-center transition duration-300 hover:bg-gray-500 cursor-pointer'])
